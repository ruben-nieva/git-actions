...
export class QueryClientImpl {
    ...
    Nym(request) {
        ...
        const promise = this.rpc.request("cheqdid.cheqdnode.cheqd.Query", "Nym", data);
        return promise.then((data) => QueryGetNymResponse.decode(new Reader(data)));
    }
    NymAll(request) {
        const data = QueryAllNymRequest.encode(request).finish();
        const promise = this.rpc.request("cheqdid.cheqdnode.cheqd.Query", "NymAll", data);
